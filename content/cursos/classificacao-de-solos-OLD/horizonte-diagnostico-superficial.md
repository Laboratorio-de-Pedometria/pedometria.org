...
graph TB
  ...
  ORGANICA -->|FALSE| CORG_6
  VEGETAL -->|TRUE| O_LITICO
  VEGETAL -->|FALSE| CERAMICA
  O_LITICO -->|TRUE| O_10CM
  O_LITICO -->|FALSE| O_FRAGMENTO
  O_FRAGMENTO -->|TRUE| O_10CM
  O_FRAGMENTO -->|FALSE| O_CASCALHO
  O_CASCALHO -->|TRUE| O_10CM
  O_CASCALHO -->|FALSE| TECIDO
  O_10CM -->|TRUE| HISTICO
  O_10CM -->|FALSE| O_5CM
  TECIDO -->|TRUE| O_ESPESSO
  TECIDO -->|FALSE| O_TIPICO
  O_ESPESSO -->|TRUE| HISTICO
  O_ESPESSO -->|FALSE| O_5CM
  O_TIPICO -->|TRUE| HISTICO
  O_TIPICO -->|FALSE| O_5CM
  HISTICO{O_HISTICO}
  O_5CM -->|TRUE| O_FRACO
  O_5CM -->|FALSE| O_MODERADO
  O_FRACO{O_FRACO}
  O_MODERADO{O_MODERADO}
  CORG_6 -->|TRUE| VALOR_4_H20
  CORG_6 -->|FALSE| SB65
  VALOR_4_H20 -->|TRUE| VALOR_6_AR
  VALOR_4_H20 -->|FALSE| A_5CM
  VALOR_6_AR -->|TRUE| GRAOS_SIMPLES
  VALOR_6_AR -->|FALSE| A_5CM
  GRAOS_SIMPLES -->|TRUE| A_FRACO
  GRAOS_SIMPLES -->|FALSE| FRACO_MACICA
  FRACO_MACICA -->|TRUE| A_FRACO
  FRACO_MACICA -->|FALSE| GRAU_FRACO
  GRAU_FRACO -->|TRUE| A_FRACO
  GRAU_FRACO -->|FALSE| A_5CM
  SB65 -->|TRUE| CACO3
  SB65 -->|FALSE| INEQUACAO
  CACO3 -->|TRUE| CORG25
  CACO3 -->|FALSE| CERAMICA
  CORG25 -->|TRUE| SB65_2
  CORG25 -->|FALSE| CERAMICA
  SB65_2 -->|TRUE| CHERNOZEMICO
  SB65_2 -->|FALSE| PROEMINENTE
  INEQUACAO -->|TRUE| HUMICO
  INEQUACAO -->|FALSE| CACO3
  CHERNOZEMICO{CHERNOZEMICO}
  HUMICO{HUMICO}
  PROEMINENTE{PROEMINENTE}
  CERAMICA -->|TRUE| FOSFORO
  CERAMICA -->|FALSE| A_5CM
  FOSFORO -->|TRUE| P20CM
  FOSFORO -->|FALSE| A_5CM
  P20CM -->|TRUE| ANTROPICO
  P20CM -->|FALSE| A_5CM
  ANTROPICO{ANTROPICO}
  A_5CM -->|TRUE| A_FRACO
  A_5CM -->|FALSE| A_MODERADO
  A_FRACO{A_FRACO}
  A_MODERADO{A_MODERADO}
```
