...
## Conjunto de dados do  'V Reunião de classificação, correlação e aplicação de levantamentos de solo - Guia de excursão de estudos de solos nos estados de Pernambuco, Paraíba, Rio Grande do Norte, Ceará e Bahia.'
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0654`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0654/ctb0654-identificacao.txt',function (data) {
