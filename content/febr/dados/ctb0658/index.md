...
## Levantamento de reconhecimento de média intensidade dos solos e avaliação da aptidão agricola das terras de 21.000 hectares no Município de Tefé, Amazonas
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0658`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0658/ctb0658-identificacao.txt',function (data) {
