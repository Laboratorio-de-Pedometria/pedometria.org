...
## Conjunto de dados do levantamento de reconhecimento 'Levantamento de Reconhecimento dos Solos da Região Sob influência do Reservatório de Furnas'
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0647`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0647/ctb0647-identificacao.txt',function (data) {
