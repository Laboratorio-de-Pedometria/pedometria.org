...
## Conjunto de dados do levantamento detalhado 'Solos do Campo Experimental da Embrapa Algodão, em Patos-PB Levantamento Detalhado e Potencial Edáfico'
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0589`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0589/ctb0589-identificacao.txt',function (data) {
