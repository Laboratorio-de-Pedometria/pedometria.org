...
## Conjunto de dados do solo da bacia do reservatório do DNOS-CORSAN, Santa Maria, RS
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0003`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0003/ctb0003-identificacao.txt',function (data) {
