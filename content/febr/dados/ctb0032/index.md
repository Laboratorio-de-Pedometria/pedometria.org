...
## Zoneamento Socioeconômico-Ecológico do Estado de Rondônia – Dados morfológicos dos horizontes do solo de cada perfil
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0032`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0032/ctb0032-identificacao.txt',function (data) {
