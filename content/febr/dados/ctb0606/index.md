...
## Conjunto de dados do  'Caracterização de Ambientes na Chapada dos Veadeiros / Vale do Rio Paranã: Contribuição para a Classificação Brasileira de Solos'
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0606`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0606/ctb0606-identificacao.txt',function (data) {
