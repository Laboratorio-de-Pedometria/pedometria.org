...
## Conjunto de dados do levantamento semidetalhado 'Inventário das terras em microbacias hidrográficas, 21 Microbacia: Rio Pesqueiro (Xanxerê,SC).
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0629`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0629/ctb0629-identificacao.txt',function (data) {
