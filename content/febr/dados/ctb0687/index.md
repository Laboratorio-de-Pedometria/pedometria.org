...
## Conjunto de dados do levantamento de reconhecimento 'Levantamento de Reconhecimento dos Solos do Núcleo Colonial de Gurguéia.'
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0687`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0687/ctb0687-identificacao.txt',function (data) {
