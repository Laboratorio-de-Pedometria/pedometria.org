...
## Conjunto de dados do levantamento exploratório 'Levantamento Exploratório dos Solos da Região Sob Influência da Cia. Vale do Rio Doce.'
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0691`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0691/ctb0691-identificacao.txt',function (data) {
