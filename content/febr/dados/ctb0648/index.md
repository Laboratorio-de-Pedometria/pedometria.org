...
## Conjunto de dados do levantamento semidetalhado 'Levantamento Semidetalhado de Solos da Área do Centro Nacional de Pesquisa de Gado de Leite, Coronel Pacheco, MG'
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0648`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0648/ctb0648-identificacao.txt',function (data) {
