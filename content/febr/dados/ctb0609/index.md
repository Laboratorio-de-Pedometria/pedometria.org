...
## Conjunto de dados do levantamento de reconhecimento de baixa intensidade 'Levantamento de Reconhecimento de Baixa Intensidade dos Solos e Aptidão Agrícola das Terras de Parte da Região Geoeconômica de Brasília'
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0609`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0609/ctb0609-identificacao.txt',function (data) {
