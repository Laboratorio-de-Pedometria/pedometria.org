...
## Reunião de Correlação, Classificação e Aplicação de Levantamentos de Solos da Região Centro-Oeste RCC - GO/MT
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0569`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0569/ctb0569-identificacao.txt',function (data) {
