...
## Levantamento de reconhecimento de média intensidade dos solos e avaliação da aptidão agrícola das terras de uma area sob influência dos rios Araguari, Falsino e Tartarugal Grande-Território Federal do Amapá
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0663`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0663/ctb0663-identificacao.txt',function (data) {
