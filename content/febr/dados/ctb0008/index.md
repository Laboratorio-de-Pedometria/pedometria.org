...
## Conjunto de dados do artigo 'Caracterização de solos com a chernozêmico na Zona da Mata norte do estado de Pernambuco'
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0008`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0008/ctb0008-identificacao.txt',function (data) {
