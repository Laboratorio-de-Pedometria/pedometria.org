...
## Caracterização pedológica em áreas de encosta do rebordo do planalto do RS
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0030`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0030/ctb0030-identificacao.txt',function (data) {
