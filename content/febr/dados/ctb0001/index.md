...
## Conteúdo de ferro do solo sob dois sistemas de cultivo na Estação Experimental Terras Baixas nos anos de 2012 e 2013
...
{{% alert note %}}
Use este identificador para citar ou linkar para este item: `https://www.pedometria.org/febr/dados/ctb0001`
{{% /alert %}}
...
<script type='text/javascript'>
  d3.tsv('/febr/dados/ctb0001/ctb0001-identificacao.txt',function (data) {
