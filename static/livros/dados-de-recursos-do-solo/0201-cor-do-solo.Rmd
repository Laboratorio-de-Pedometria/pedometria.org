...
A cor do solo é uma expressão qualitativa da percepção visual que seres humanos têm do solo. Essa percepção é resultado da impressão que a luz refletida pelo solo produz nos olhos do observador. Logo, trata-se de uma qualidade perceptível apenas na presença de luz visível, sejam elas provenientes de fontes artificiais ou naturais. Essa luz visível corresponde aos comprimentos de onda entre cerca de 400 e 700 nm, porção do espectro eletromagnético popularmente conhecida como espectro óptico ou espectro do visível. Ignorados os principais fatores intervenientes (imperfeições do olho ou cérebro do observador, condições do ambiente circunvizinho, intensidade da luz, ângulo de incidência e visada), a cor do solo resulta da repartição diferencial dos comprimentos de onda da luz visível incidente entre os fenômenos de absorção, transmissão e reflexão. Essa repartição diferencial é fruto da maneira como os vários constituíntes do solo interagem com a radiação eletromagnética. É a radição presente nos comprimentos de onda do visível (fótons) que deixam a superfície do solo em maior quantidade, por reflexão ou, inclusive, emissão, que ditam a cor do solo.
