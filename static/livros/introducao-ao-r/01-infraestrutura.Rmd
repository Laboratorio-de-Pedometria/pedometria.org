...
![__Figura 1.__ RStudio: ambiente de desenvolvimento integrado (IDE) para R em sua versão para Linux.](img/rstudio.png)
...
O diretório de arquivos do projeto contém cinco subdiretórios. Cada um deles tem o propósito de armazenar arquivos com conteúdos específicos:
...
Agora crie um novo arquivo do R e
