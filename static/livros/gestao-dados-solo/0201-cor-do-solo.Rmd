...
A __cor do solo__ é uma expressão qualitativa da percepção visual que seres humanos têm do solo. Essa percepção é resultado da impressão que a luz refletida pelo solo produz nos olhos do observador. Logo, trata-se de uma qualidade perceptível apenas na presença de luz visível, sejam elas provenientes de fontes artificiais ou naturais.
