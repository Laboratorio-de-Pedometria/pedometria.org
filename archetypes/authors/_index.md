...
# Função/Posição (escolha a opção abaixo que melhor descreve sua função):
# - Professor Adjunto
...
# Biografia curta (máximo de duas linhas), mostrada no final das postagens de sua autoria
bio: ""
